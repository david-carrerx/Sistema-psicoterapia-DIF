    ...
    <form id="patient-form" method="POST" action="/agregar-pacientes" class="container formulario">
        ...
        <div class="row" name="row_form">
            <div class="col-5"><label for="name">Nombre completo<span>*</span></label>
                <br><input class="patient_name" id="name" name="name" type="text" placeholder=" Nombre del paciente" autofocus
                    pattern="[\p{L}\s]+" autocomplete="off" required>
            </div>
        ...
        <div class="row" name="row_form">
            ...
            <div class="col-3"><label for="phone">Celular<span>*</span></label><br>
                <input id="phone" name="phone" type="text" placeholder="Número telefónico" min="1" max="120"
                    maxlength="10" pattern="\d{10}" autocomplete="off" required>
            </div>
        </div>
        <div class="row" name="row_form">
            <div class="col-5"><label for="address">Domicilio<span>*</span></label><br>
                <input id="address" name="address" type="text" placeholder="Domicilio del paciente"
                    autocomplete="off" required>
            </div>
            <div class="col-4"><label for="religion">Religión<span class="asterisk">*</span></label><br>
                <input id="religion" name="religion" type="text" placeholder="Religión del paciente"
                    autocomplete="off" >
            </div>
            <div class="col-3"><label for="job">Ocupación<span>*</span></label><br>
                <input id="job" name="job" type="text" placeholder="Ocupación del paciente"
                    autocomplete="off" required>
            </div>
        </div>
        <div class="row" name="row_form">
            <div class="col-9">
                ...
                <label for="checkbox2" name="consulta">a) ¿Ha recibido ayuda psicológica por parte de otra
                    situación?</label><br>
                ...
                <span id="checkbox-error" style="color: red; display: none;">Selecciona al menos una
                    opción.</span>
            </div>
        </div>
        <div class="row" name="row_form">
        ...
        <div name="row_form">
            <div class="col-13"><label for="description">Descripción de su situación actual</label><br>
                <textarea name="description" id="description" 
                    placeholder="Escriba la situación actual"></textarea>
            </div>
        </div>
